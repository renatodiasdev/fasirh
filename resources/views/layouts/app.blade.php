                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('/funcionarios/buscar') }}"><i class="fa fa-btn fa-search"></i>Buscar</a></li>
                            <li><a href="{{ url('/funcionarios/funcionario') }}"><i class="fa fa-btn fa-plus"></i>Novo</a></li>
                        </ul>
                    </li>
                </ul>
